...
const char* ssid = "SFR_1C90";         // Remplacez par le nom de votre réseau Wi-Fi
const char* password = "teq48mxbg3cww42jfci2"; // Remplacez par le mot de passe de votre réseau

const char* host = "192.168.1.45";  // Remplacez par l'IP de votre PC
const uint16_t port = 12345;         // Doit correspondre au port du serveur Python
